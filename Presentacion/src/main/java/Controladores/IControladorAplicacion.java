...
public interface IControladorAplicacion {
    ...
    /**
     * Inicia el flujo de compra limpiando cualquier selección anterior y
     * llevando al usuario a elegir sucursal.
     */
    ...
    /**
     * Inicia el flujo de agendar cita desde el perfil (cliente ya tiene
     * membresia). Recupera la sucursal de la membresia activa antes de ir a
     * seleccion de instructor.
     */
     ...
     * Si el pago es exitoso navega a la pantalla de transacción exitosa, si
     * falla navega a la de transacción fallida.
     */
    ...
    // --- mapa ---
    /**
     * Interfaz funcional para recibir el id de la sucursal cuando el usuario
     * hace clic en un marcador del mapa.
     */
    @FunctionalInterface
    ...
    /**
     * Registra el listener que se llama cuando el usuario hace clic en un
     * marcador.
     *
    ...
    /**
     * Apaga el servidor HTTP del QR. Hay que llamar esto al salir de
     * PantallaQR.
     */
    void detenerServidorQR();

    /**
     * Lanza un hilo que consulta la API de geolocalización por IP y centra el
     * mapa en la ubicación aproximada del usuario.
     */
