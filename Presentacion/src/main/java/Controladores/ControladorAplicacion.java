...
public class ControladorAplicacion implements IControladorAplicacion {
    ...
    @Override
    public void setSucursalSeleccionada(SucursalDTO s) {
    ...
    @Override
    public void setPlanSeleccionado(PlanDTO p) {
    ...
    @Override
    public void setExtrasSeleccionados(List<AmenidadDTO> e) {
        this.extrasSeleccionados = e;
    }
    ...
    @Override
    public void setEntrenadorSeleccionado(EntrenadorDTO e) {
    ...
    @Override
    public void setHorarioSeleccionado(HorarioDTO h) {
    ...
    public void iniciarSesion(String correo, String contrasena) throws Exception {
        ...
        this.citaBienvenida = compraFachada.obtenerCitaBienvenida(usuarioActual.getCorreo());
        irAPerfilUsuario();
    }
    ...
    public CitaDTO obtenerCitaBienvenida() {
        ...
        return compraFachada.obtenerCitaBienvenida(usuarioActual.getCorreo());
    }
    ...
    public void confirmarCitaBienvenida() {
        ...
        this.citaBienvenida = compraFachada.agendarCita(dto);
    }
