...
/**
 * Clase que representa un pojo de una amenidad
 * @author Tungs
 */
public class AmenidadPojo {
    ...
    public AmenidadPojo(String idAmenidad, String nombre, String descripcion, TipoAmenidad tipo, Double costo) {
